public class FacturaCafeteria {
    public static void main(String[] args) {
        ...
        double descuento = aplicaDescuento ? total * 0.10 : 0; // Se utiliza el Operador Ternario
...
a = 2;
a++; //3
++a; // El primero toma la variable y luego la suma, el segundo lo suma y despues toma la variable
